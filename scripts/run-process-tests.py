...
raise SystemExit(subprocess.call(["cargo", "test", "--manifest-path", str(root / "src-tauri/Cargo.toml"), "process_integration_tests", "--", "--ignored", "--test-threads=1"], cwd=root, env=env))
